...
Object.prototype.unassignAll = function () {
  ((t)=>{Object.keys(t).forEach((i)=>{delete this[i]},t)})(this.valueOf())
}
...
Object.prototype.getValues = function (...keys) {
  return keys.map(i => this[i])
}

Boolean.OR = (...v) => v.some(i => i == true)
Boolean.AND = (...v) => v.every(i => i == true)
Boolean.XOR = (...v) => (v.some(i => i == false) && v.some(i => i == true))
Boolean.NOR = (...v) => v.every(i => i == false)
Boolean.NAND = (...v) => v.some(i => i == false)
Boolean.XNOR = (...v) => (v.every(i => i == false) || v.every(i => i == true))
