const tech = {
    ...
    {
        name: "nitinol",
        description: `<strong>1.3x</strong> <strong>movement</strong> and <strong>jumping</strong>
    ...
    },
    {
        ...
        frequencyDefault: 2,
        allowed() {
            return tech.isNitinol && !simulation.ephemera.includes(obj => obj.name === "blockJump");
        },
        requires: "nitinol, not working mass",
        effect() {
            if (!simulation.ephemera.includes(obj => obj.name === "blockJump")) {
                tech.isCoyote = true
    ...
    },
    {
        ...
        description: `<strong>4x</strong> <em>fire rate</em>
        	<br>while <strong>firing</strong> your <strong>position</strong> is fixed`,
        maxCount: 1,
        count: 0,
        frequency: 1,
        frequencyDefault: 1,
    ...
    {
        name: "aperture",
        description: `every <strong>4</strong> seconds your <strong class='color-d'>damage</strong> cycles
        	<br>between <strong>0.8x</strong> and <strong>3x</strong> <strong class='color-d'>damage</strong>`,
        maxCount: 1,
        count: 0,
        frequency: 1,
        frequencyDefault: 1,
    ...
    {
        name: "diaphragm",
        description: `every <strong>4</strong> seconds your <strong class='color-defense'>damage taken</strong> cycles
        	<br>between <strong>0.9x</strong> and <strong>0.2x</strong> <strong class='color-defense'>damage taken</strong>`,
        maxCount: 1,
        count: 0,
        frequency: 2,
        frequencyDefault: 2,
    ...
    },
    {
        ...
        allowed() {
            return !m.isAltSkin && !tech.isPiezo && !tech.isRewindAvoidDeath && !tech.isAnnihilation &&
              !tech.isNoDeath && !(m.fieldMode === 12)//&& !tech.isAmmoFromHealth && !tech.isRewindGun
        },
        requires: "not skinned, piezoelectricity, CPT, annihilation, quantum Zeno effect, energy condenser",
        damage: 1.5,
        effect() {
            m.damageDone *= this.damage
    ...
    */
    ...
    {
        name: "ordnance",
        description: `spawn ${powerUps.orb.gun()} and get <strong>2x</strong> <em class='flicker'>frequency</em> for ${powerUps.orb.gunTech()}
    ...
    },
	{
      	...
      	description: `attempting to <span class="color-remove">remove</span> <strong class="color-text">marginal utility</strong>
        	<br>instead <strong>randomizes</strong> the boosted <strong class="color-g">gun</strong>`,
      	maxCount: 1,
      	count: 0,
      	frequency: 1,
      	frequencyDefault: 1,
    ...
    },
    {
        ...
        descriptionFunction() {
            ...
            return `once per level, if <strong class='color-h'>health</strong> < <strong>0</strong> use ${powerUps.orb.research(1)} to survive
            	<br>and spawn ${powerUps.orb.heal(22)}<em style ="float: right;">(${(!tech.isDeathAvoidedThisLevel && powerUps.research.count > 0) ? "on" : "off"})</em>`
    ...
    },
    {
        ...
        description: `clicking <strong class='color-cancel'>cancel</strong> for ${powerUps.orb.field()}, ${powerUps.orb.tech()}, or ${powerUps.orb.gun()}
        	<br>will <strong>randomize</strong> with <strong>3x</strong> <strong class='color-choice'><span>ch</span><span>oi</span><span>ces</span></strong>,
    ...
    },
	{
      ...
      description: `<strong>1.1x</strong> <strong class='color-d'>damage</strong>
      	<br><span class='color-remove'>removing</span> this spawns a <strong>random</strong> power-up for each <strong class="color-g">gun</strong>`,
      maxCount: 1,
      count: 0,
      frequency: 1,
      frequencyDefault: 1,
    ...
    },
    {
        ...
        requires: "foam, not devil's toothpaste",
        effect() {
    ...
    {
	name: "devil's toothpaste",
	description: `<strong>1.33x</strong> <strong>foam</strong> <strong class='color-d'>damage</strong>
	<br><strong class='color-e'>explosions</strong> cause <strong>foam</strong> bubbles to also <strong class='color-e'>explode</strong>`,
	isGunTech: true,
	maxCount: 1,
	count: 0,
	frequency: 1,
    ...
    },
    {
        ...
        requires: "standing wave, wormhole, pilot wave, Einstein's shield",
        effect() {
            tech.energyDamage++
        },
        remove() {
    ...
    },
    {
        ...
        requires: "standing wave, perfect diamagnetism, pilot wave, Einstein's shield",
        effect() {
    ...
    },
    {
        ...
        requires: "",
        effect() {
            let soundScript = undefined/*, scriptListItem = null*/;
            try {
                tech.isSounds = true;
                soundScript = document.createElement('script');
                soundScript.src = 'js/audioPlayer.js';
                ...
                soundScript.onload = () => {
                    try {
                        let scriptIDX = scripts.findIndex(script => script.src === soundScript.src);
                        const audioButtonElements = document.querySelectorAll('.audio-script');
                        if (scripts[scriptIDX]) {
                            scripts[scriptIDX].loaded = true;
                            try {
                                audioButtonElements.forEach(element => {
                        ...
                        simulation.inGameConsole(`<span style='color:red;'><strong>ERROR REMOVING AUDIO BUTTONS:</strong>
                            <br>${err}</strong></span>`);
                        window.alert(`ERROR REMOVING AUDIO BUTTONS:
${err}`);
                    }
                }
                    */
            } catch (error) {
                simulation.inGameConsole(`<span style='color:red;'<strong>ERROR LOADING AUDIO PLAYER:</strong>
                    <br>${error}</strong></span>`);
            }
        },
        remove() {}
    },
    ...
    },
    {
      	...
      	description: `spawn a power up that lets you
      		<br> <strong style="color:rgb(110,155,160)"><em>warp</em></strong> to another level`,
      	maxCount: 1,
      	count: 1,
      	frequency: 0,
      	isInstant: true,
