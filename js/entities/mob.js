setTimeout(() => {
  fileLoads.isMobJS = true; //for file handling in fileTester.js
}, 10);
              ...
              if (this.health === 1) {
                if (tech.isMobFullHealthCloak) {
                  ...
                  simulation.ephemera.push({
                    name: `damage outline ${simulation.newEphemeraID()}`,
                ...
                if (tech.isChatter && !this.isInvulnerable) {
                  ...
                  if (!isTalking) {
                    const quotes = [
                      ...
                      "I looove GD Cologne.",
                      "Only the Mantis Lords? Are you joking?",
      ...
      death() {
        ...
        if (this.isDropPowerUp) {
          ...
          if (tech.isMobDeathImmunity) {
            const immuneTime = 300 * ((m.fieldMode === 0 || m.fieldMode === 14) ? m.immuneBoostCouple : 1);
