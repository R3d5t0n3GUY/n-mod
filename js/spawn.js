...
const spawn = {
    ...
    bossTier: [
        ...
        ["sneakBoss", "blockBoss", "laserTargetingBoss", "blinkBoss", "pulsarBoss", "spawnerBossCulture", "growBossCulture"],
        ["powerUpBossBaby", "laserLayerBoss", "historyBoss", "beetleBoss", "snakeSpitBoss", "mantisBoss", "laserBombingBoss", "cellBossCulture", "bomberBoss", "timeSkipBoss"],
        ["powerUpBoss", "stagBeetleBoss", "kingSnakeBoss", "fabricatorBoss", "pentaLaserBoss"]
        //finalBoss is T5
    ],
    forefitList: [
      ...
      `Give this bounty to someone else, eh? Your fat a** takes up too much room here.`,
      ...
      `finalBoss told me to start looking for fashionable clothing. <br>
          For the record, he sends ravens to say hi to his toes.`,
    ],
    ...
    powerUpBossBaby(x, y, vertices = 9, radius = 60) {
        ...
        me.onHit = function () { //run this function on hitting player
            if (powerUps.ejectTech() && Math.random() < 0.37) {
